...
namespace RestFlow
{
    public class Waiter : Employee
    {
        ...
        public Waiter(Employee employee) : base(employee.Login, employee.Password, employee.Name, employee.Surname, employee.Birthday, employee.Gender, employee.Phone, employee.Salary)
        {
            Post = "Официант";
        }
    }
