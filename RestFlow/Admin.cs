...
namespace RestFlow
{
    public class Admin : Employee
    {
        ...
        public Admin(Employee employee) : base(employee.Login, employee.Password, employee.Name, employee.Surname, employee.Birthday, employee.Gender, employee.Phone, employee.Salary)
        {
            Post = "Админ";
        }
    }
